  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="relative h-[50vh] min-h-[400px] w-full overflow-hidden">
        ...
        {/* Play Trailer Button - Now links to watch page */}
        {trailer && (
          <div className="absolute inset-0 flex items-center justify-center">
            <Button size="lg" className="rounded-full h-16 w-16 flex items-center justify-center" asChild>
              <Link href={watchUrl}>
                        ...
                        <div>
                          ...
                          {cast.length > 10 && (
                              <Button variant="link" className="mt-4" asChild>
                                <Link href={`/${type}/${data.id}/cast`}>View Full Cast & Crew</Link>
                              </Button>
                          )}
                        </div>
                    ) : (
                        ...
                        <div className="mt-8">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                            {crew
                                ...
                                .slice(0, 6)
                                .map((person: any) => (
                                    <div key={`${person.id}-${person.job}`} className="flex items-start gap-3">
